                ...
                <div class="p-6">
                    <form method="POST" action="{{ route('users.store') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="relative">
                                <x-input id="password_confirmation" class="block mt-1 w-full pr-10" type="password" name="password_confirmation" required />
                        ...
                        <div class="mb-4">
                            ...
                            <x-input id="rfc" class="block mt-1 w-full" type="text" name="rfc" :value="old('rfc')" maxlength="14" placeholder="RFC (opcional)" />
                            @error('rfc')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <x-input id="curp" class="block mt-1 w-full" type="text" name="curp" :value="old('curp')" maxlength="22" placeholder="CURP (opcional)" />
                            @error('curp')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <select id="nivel" name="nivel" class="block mt-1 w-full border-gray-300 dark:border-gray-600 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100">
                                <option value="7" {{ old('nivel', 7) == 7 ? 'selected' : '' }}>7 - Usuario</option>
                                <option value="6" {{ old('nivel') == 6 ? 'selected' : '' }}>6 - Editor</option>
                                <option value="5" {{ old('nivel') == 5 ? 'selected' : '' }}>5 - Moderador</option>
                                <option value="4" {{ old('nivel') == 4 ? 'selected' : '' }}>4 - Supervisor</option>
                                <option value="3" {{ old('nivel') == 3 ? 'selected' : '' }}>3 - Administrador</option>
                                <option value="2" {{ old('nivel') == 2 ? 'selected' : '' }}>2 - Super Admin</option>
                                <option value="1" {{ old('nivel') == 1 ? 'selected' : '' }}>1 - Root</option>
                            </select>
                            @error('nivel')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        ...
                        <div class="mb-4">
                            <div class="flex items-center">
                                <x-checkbox id="estatus" name="estatus" value="1" :checked="old('estatus')" />
                        ...
                        <div class="mb-4">
                            ...
                            <select id="theme" name="theme" class="block mt-1 w-full border-gray-300 dark:border-gray-600 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100">
                                <option value="dark" {{ old('theme', 'dark') == 'dark' ? 'selected' : '' }}>{{ __('Oscuro') }}</option>
